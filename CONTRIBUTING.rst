...
ZOAdaQN uses the Gitflow model. Contributors should typically branch from, and
...
ZOAdaQN is distributed under a default MIT license (see LICENSE_), with 
...
.. _LICENSE: https://github.com/poptus/ZOAdaQN/blob/main/LICENSE
