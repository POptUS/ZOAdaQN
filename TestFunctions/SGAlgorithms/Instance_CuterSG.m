...
steps={2^-10, 2^-12, 2^-10, 2^-11, 2^-13,2^-5,2^-11,2^-10,2^-13,2^-5,2^-9,2^-8,2^-9,2^-9,2^-8,2^-8,2^-10,2^-10,2^-6,2^-6,2^-20,2^-20}; 
Options.DFODirs=[];
for dat=1:22
    for seed=1:5   
        data=datas{dat};
...
steps={2^-10, 2^-12, 2^-10, 2^-11,2^-13,2^-5,2^-10,2^-10,2^-13,2^-5,2^-11,2^-8,2^-9,2^-9,2^-8,2^-8,2^-10,2^-10,2^-6,2^-6,2^-20,2^-20}; 
for dat=1:22
    for seed=1:5  
        data=datas{dat};
        Options.lambda=sigma;
...
sigma=10^-5;
Options.S0=2;
steps={2^-13, 2^-12, 2^-13, 2^-12, 2^-14,2^-8,2^-12,2^-11,2^-14,2^-8,2^-11,2^-11,2^-11,2^-11,2^-9,2^-9,2^-15,2^-15,2^-13,2^-13,2^-24,2^-24}; %for ss
...
sigma=10^-3;
Options.S0=2;
variables={30,20,30,8,50,11,20,8,50,11,125,125,110,110,100,100,100,100,100,100,100,100,100,100,100,100};
steps={2^-15, 2^-12, 2^-14, 2^-12,2^-14,2^-8,2^-12,2^-11,2^-14,2^-8,2^-12,2^-11,2^-11,2^-11,2^-9,2^-9,2^-15,2^-15,2^-13,2^-13,2^-24,2^-24};   % For SS
